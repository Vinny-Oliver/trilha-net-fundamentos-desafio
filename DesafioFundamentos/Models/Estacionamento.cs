namespace DesafioFundamentos.Models
{
    public class Estacionamento
    {
        ...
        public void AdicionarVeiculo()
        {
            ...
            Console.WriteLine("Digite a placa do veículo para estacionar:"); // Mensagem de exibição
            string placa = Console.ReadLine(); // Local do input do usuário
            veiculos.Add(placa); // Adicionado um veículo na lista
            Console.WriteLine($"Veículo {placa} adicionado."); // Mensagem de exibição
        }
